...
void save_callback()
{
	...
	Interfaces::CVar->ConsoleColorPrintf(Color(30, 255, 30, 255), "Mirror v5 ");
...
#pragma region Aimbot
	...
	resolver.AddItem("FreaK - Prediction");
	...
	Multival.SetFileId("yesdeseses");
	Multival.SetBoundaries(0, 100);
	Multival.SetValue(20);
	Multival.extension = XorStr("%%");
	AimbotGroup.PlaceLabledControl(2, "", this, &Multival);
...
#pragma endregion Setting up the Options controls
	...
	//	ChamsTeamVis.SetFileId("chams_team_vis");
	//	ChamsGroup.PlaceLabledControl(0, "Team (Visible)", this, &ChamsTeamVis);
	//	ChamsTeamNoVis.SetFileId("chams_team_novis");
	//	ChamsGroup.PlaceLabledControl(0, "Team (Invisible)", this, &ChamsTeamNoVis);
	ChamsLocal.SetFileId("chams_local");
	ChamsGroup.PlaceLabledControl(0, "Local Chams", this, &ChamsLocal);
	HandCHAMS.SetFileId("chams_local_hand");
	HandCHAMS.AddItem("off");
	HandCHAMS.AddItem("Simple");
	HandCHAMS.AddItem("Wireframe");
	HandCHAMS.AddItem("NoDraw");
	HandCHAMS.AddItem("Golden");
	HandCHAMS.AddItem("Glass");
	ChamsGroup.PlaceLabledControl(0, "Hand Chams", this, &HandCHAMS);
	GunCHAMS.SetFileId("chams_local_weapon");
	GunCHAMS.AddItem("off");
	GunCHAMS.AddItem("Simple");
	GunCHAMS.AddItem("Wireframe");
	GunCHAMS.AddItem("NoDraw");
	GunCHAMS.AddItem("Golden");
	GunCHAMS.AddItem("Glass");
	ChamsGroup.PlaceLabledControl(0, "Weapon Chams", this, &GunCHAMS);
...
#pragma region WORLD IS DOOMED AND FLAT AND GAY AND TRUMP IS LITERALLY HITLER AND FREAK IS THE QUEEN OF MARS
	...
	worldgroup.PlaceLabledControl(0, "Brightness percantage", this, &colmod);
...
#pragma region Other
	...
	//	KnifeBot.SetFileId("otr_knifebot");
	...
	//	NoSpreadHVH.SetFileId("stfudoggokys");
	//	OtherGroup.PlaceLabledControl(0, "", this, &NoSpreadHVH);
	...
	DebugHitbones.SetFileId("multipoint_debug");
	OtherGroup.PlaceLabledControl(0, "Debug Multipoint", this, &DebugHitbones);

	aa_helper.SetFileId("aahelper");
	OtherGroup.PlaceLabledControl(0, "Fake Angle Ghost", this, &aa_helper);
